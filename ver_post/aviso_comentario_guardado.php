					...
					<div id='marco_1'>
						<ul id='lista_respuesta'>
							<li class='campos' id='cam_a'>
								<span class='texto_2'>
									Tu comentario fue enviado correctamente, ahora seras devuelto al post del que venias
								</span>
								<?php
									header("location: ../ver_post.php?post_id=$_GET[ant_post]");
								?>
							</li>
							...
							<li class='campos' id='cam_a'>
								<span class='texto_2'>
									<?php
										$post_anterior= $_GET['ant_post'];
									?>
									<button type='button' onClick="location.href='../ver_post.php?post_id=<?php echo $post_anterior; ?>'">
										Volver al post
									</button>
								</span>
							</li>
