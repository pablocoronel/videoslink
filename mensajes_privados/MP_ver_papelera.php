				...
				<div id='MP_fondo'>
					...
					<div id='MP_listado'>
						...
						<div id='ver_opc'>
							...
							?>
							<a href="MP_borrar.php?user=<?php echo $_SESSION['login_id']; ?>&id_leer=<?php echo $_GET['id_MP']; ?>&tipo=<?php echo $tipo; ?>&accion=restaurar">
								<input type='button' id='submit_ver' name='restaurar' value='Restaurar'>
							</a>
							<a href="MP_borrar.php?user=<?php echo $_SESSION['login_id']; ?>&id_leer=<?php echo $_GET['id_MP']; ?>&tipo=<?php echo $tipo; ?>&accion=eliminar_def">
								<input type='button' id='submit_ver_pap' name='borrar' value='Eliminar Definitivamente'>
							</a>
						</div>
					</div>
				</div>
