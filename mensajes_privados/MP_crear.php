			...
			<div id='content'>
				<div id='MP_fondo'>
					...
					<div id='MP_listado'>
						...
						<div id='ver_cab'>Redactar Mensaje</div>
						<div id='ver_tit'>
							<span class='cabeceras_titulo'>Asunto:</span>
							<span class='cabeceras_dato'><input type='text' name='asunto'></span>
						</div>
						<div id='ver_remit'>
						...
						<div id='ver_fec'>
							<?php
								if(isset($_GET['user_dest'])){
									$destinatario= $_GET['user_dest'];
								}else{
									$destinatario= '';
								}
							?>
							<span class='cabeceras_titulo'>Para:</span>
							<span class='cabeceras_dato'><input type='text' name='destinatario' value="<?php echo $destinatario; ?>"></span>	
						</div>
						<div id='ver_cont'>
								<textarea name='contenido_MP' cols='10' rows='12'></textarea>
						</div>
						<div id='ver_opc'>
