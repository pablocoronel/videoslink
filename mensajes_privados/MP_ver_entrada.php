...
$sql_ver="UPDATE mensajes_privados SET estado_leido = 'si' WHERE id_destinatario = '$_SESSION[login_id]'
			AND id = '$_GET[id_MP]'";
mysqli_query($conexion,$sql_ver);
?>
			...
			<div id='content'>
				<div id='MP_fondo'>
					...
					<div id='MP_listado'>
						...
						<div id='ver_opc'>
							<input type='submit' id='submit_ver' name='responder' value='Responder'>
							<?php
							...
							<a href="MP_borrar.php?user=<?php echo $_SESSION['login_id']; ?>&id_leer=<?php echo $_GET['id_MP']; ?>&tipo=<?php echo $tipo; ?>&accion=papelera">
								<input type='button' id='submit_ver_pap' name='borrar' value='Papelera'>
							</a>
						</div>
						</form>
					</div>
