					...
					<div id='marco_1'>
						<ul id='lista_respuesta'>
							<li class='campos' id='cam_a'>
								<span class='texto_2'>
				<?php
					$sql="SELECT * FROM registro_usuarios WHERE codigo_registro = '$_GET[cod]'";
					$res=(mysqli_query($conexion,$sql));
					if(mysqli_fetch_assoc($res)){
						$sql_2="UPDATE registro_usuarios SET estado_registro = 'finalizado'
								WHERE codigo_registro = '$_GET[cod]'";
						mysqli_query($conexion,$sql_2);
						echo "Su cuenta a sido activada correctamente";
					}else{
